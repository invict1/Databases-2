...
BEGIN
    ...
    THEN RAISE_APPLICATION_ERROR(-20002, 'UNA PARTIDA TIENE QUE TENER 4 EQUIPOS');
    END IF;
END;
...
BEGIN
    ...
    THEN RAISE_APPLICATION_ERROR(-20005, 'A UN EQUIPO SOLO SE LE PUEDE ASIGNAR UNA PARTIDA SI POSEE ENTRE 1 y 30 ARMAS');
    END IF;
END;
